...
const BenchListUploadForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // if (response.ok) {
        setMessage({ type: 'success', text: `${validResources.length} bench resources uploaded successfully in demo mode!` });
        // Reset form
      ...
      setMessage({ type: 'error', text: 'Demo mode: Network error. In a real app, this would connect to an API.' });
    } finally {
      setIsUploading(false);
    }
  };
